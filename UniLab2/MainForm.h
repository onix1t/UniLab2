...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label2->Size = System::Drawing::Size(208, 26);
			this->label2->TabIndex = 0;
			this->label2->Text = L"Здесь будет отображаться выбранный \r\nвами массив в отсортированном виде";
			// 
			// MainForm
			// 
...
#pragma endregion
		...
		private: System::Void arrType1Btn_CheckedChanged(System::Object^ sender, System::EventArgs^ e) {
			...
			long massA1[] = { 31295, 12351, 21840, 27420, 19503, 27968 };
		...
		private: System::Void arrType2Btn_CheckedChanged(System::Object^ sender, System::EventArgs^ e) {
			long massA2[] = { 19, 15, 16, 20, 20, 13, 12, 12, 10, 20, 17, 20, 19 };
		...
		private: System::Void arrType3Btn_CheckedChanged(System::Object^ sender, System::EventArgs^ e) {
			...
			long massA3[] = { 2358, 4552, 4993, 7671, 27107, 13734, 12151, 10149, 22378, 25503, 32546 };
		...
		private: System::Void runBtn_Click(System::Object^ sender, System::EventArgs^ e) {
			if (radixSortBtn->Checked) {
				radixSort(arr); // Предполагается, что arr - это ваш массив, который нужно отсортировать
			}
			...
			// После сортировки обновите содержимое groupBox3 с отсортированным массивом
		}
